...
(2, 'Hồng Vân',30,101,'Negative','None'),
(3, 'Cao Cường',30,101,'Negative','None');

CREATE VIEW Reception_Patient_View AS 
SELECT Patient_ID, Full_Name, Age, Room_Number
FROM Patients WHERE Age > 0 WITH CHECK OPTION;

SELECT * FROM Reception_Patient_View;

UPDATE Reception_Patient_View SET Age = 35 WHERE Patient_ID = 1;

UPDATE Reception_Patient_View SET Age = -5 WHERE Patient_ID = 2;
